...
description: >-
  Install Gemini CLI agents from the awesome-gemini-cli-subagents repository. Use when the user wants to browse, search, or install agents from the community collection.
---
